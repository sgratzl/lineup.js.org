...
var EngineRenderer = /** @class */ (function (_super) {
    ...
    function EngineRenderer(data, parent, options) {
        ...
        _this.forward.apply(_this, __spreadArray([dialogManager], suffix('.main', EngineRenderer.EVENT_DIALOG_OPENED, EngineRenderer.EVENT_DIALOG_CLOSED)));
    ...
    EngineRenderer.prototype.addRanking = function (ranking) {
        ...
        if (this.rankings.length > 0) {
            ...
            var s = this.table.pushSeparator(function (header, body) {
                return new SlopeGraph(header, body, ranking.id + "S", _this.ctx, {
